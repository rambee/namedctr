"""
Django settings for corporater project.
...
SECRET_KEY = '9*j6sj#e8r!2f!25gv%_db3m7k(o^457fo3ov4i-h&p@)2(v_q'
...
WSGI_APPLICATION = 'corporater.wsgi.application'
...
TIME_ZONE = 'Europe/Oslo'  # Set timezone to locale
